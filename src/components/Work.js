        ...
        <Parallax speed={-10}>
          <div className={styles.projectDetails}>
            ...
            <p className={styles.projectDesc}>
              Storly is a feature-rich e-commerce platform that brings a
              seamless shopping experience to both buyers and sellers. Explore a
              world of products at your fingertips, or set up your own store
              with ease.
            </p>
        ...
        <Parallax speed={-10}>
          <div className={styles.projectDetails}>
            ...
            <p className={styles.projectDesc}>
              ...
              makes use of Lambda functions for scheduling periodic data
              scraping tasks. After scraping, the data is stored in a Realtime
